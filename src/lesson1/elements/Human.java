...
public class Human implements Action{
    ...
    public boolean run(int distance) {
        ...
        if(distance > maxDistanceRun){
            System.out.println("Человек по имени " + name + " не смог пробежать заданную дистанцию!");
            return false;
        }

        System.out.println("Человек по имени " + name + " пробежал заданную дистанцию!");
    ...
    public boolean jump(int distance) {
        ...
        if(distance > maxDistanceJump){
            System.out.println("Человек по имени " + name + " не смог прыгнуть больше заданного расстояния!");
            return false;
        }

        System.out.println("Человек по имени " + name + " прыгнул заданное расстояние!");
